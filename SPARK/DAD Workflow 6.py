...
phone_pfx = spark.sql('Select n.lvid, n.supplier_nb, n.dt_first_rpted, n.dt_last_rpted,n.ph_nb_pfx as value, t.ty_cd From edf_bis_dd_en.bus_phone_source  n left join edf_bis_dd_en.da_sbu_firmo_sup t on n.lvid=t.lvid and n.supplier_nb=t.supplier_nb and n.dt_last_rpted=t.dt_last_rpted and n.ph_nb_pfx=t.value where t.dt_last_rpted IS NULL')
...
df_normalized = df_normalized.drop(*columns_to_drop).withColumn('element',lit('Phone_PFX')).withColumnRenamed("child_pbin", "bin")
